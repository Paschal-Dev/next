...
export default function AccountBalanceSidebar({anchor,}: SidebarProps): React.JSX.Element {
      ...
      {isDesktop ? (
        ...
        >
          <Box pt={3}>
            ...
            <Box ml={3}>
              <ul
                style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}
              >
                <li
                  onClick={() => handleClick("Account-Balance")}
                  style={{
                    paddingBottom: 2,
                    listStyleType: "disc",
                    cursor: "pointer",
                    color:
                      activeLink === "Account-Balance" ? "#009FDD" : "#000",
                  }}
                >
                ...
                <li
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    color:
                      activeLink === "Explanation-Table" ? "#009FDD" : "#000",
                  }}
                >
                  <Link
                    href="#Explanation-Table"
                    color="inherit"
                    underline="none"
                  >
                    Explanation Table
                  ...
                  <li
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      color:
                        activeLink === "Return-Values-Success-Sample"
                          ? "#009FDD"
                          : "#000",
                    }}
                  >
                    <Link
                      href="#Return-Values-Success-Sample"
                      color="inherit"
                      underline="none"
                    >
                      Return Values Success Sample
                  ...
                  <li
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      color:
                        activeLink === "Return-Values-Error-Sample"
                          ? "#009FDD"
                          : "#000",
                    }}
                  >
                    <Link
                      href="#Return-Values-Error-Sample"
                      color="inherit"
                      underline="none"
                    >
                      Return Values Error Sample
