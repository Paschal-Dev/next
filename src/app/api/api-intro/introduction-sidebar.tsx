...
export default function ApiIntroductionSidebar({
  anchor,
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ["Api-Introduction", "Api-Endpoint"];
      sections.forEach((id) => {
              ...
              >
                <li
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    color:
                      activeLink === "Api-Introduction" ? "#009FDD" : "#000",
                  }}
                >
                  <Link
                ...
                <li
                  ...
                  style={{
                    ...
                    listStyleType: "disc",
                    cursor: "pointer",
                    color: activeLink === "Api-Endpoint" ? "#009FDD" : "#000",
                  }}
                >
