...
import BalanceLedgerSidebar from "./balanceledgersidebar";

export default function BalanceLedger(): React.JSX.Element {
    ...
    <Box>
      ...
      <Box bgcolor={"whitesmoke"}>
        <Grid container spacing={5}>
            ...
            <Container>
              ...
              >
                ...
                <Typography
                  ...
                  id="End-Point"
                >
                  Ledger balance is what holds your balance, you can see the
                  movement of your balance and what gets debited and credited to
                  your account.
                </Typography>
              </Box>
              <hr
              ...
              >
                ...
                <Grid item md={5} sm={5} xs={5}>
                  ...
                  >
                    Each page carries up to 20 transactions. You must send in at
                    least 1.
                  </Typography>
                </Grid>
              </Grid>
              ...
              <Box bgcolor={"#004E6D"} p={3} mt={3} borderRadius={3}>
                ...
                >
                  ...
                  <br />
                  "debit":
                  <span style={{ color: "#FCC82B" }}>10</span>{" "}
                  <span style={{ color: "#fff" }}>,</span> <br />
                  "credit":
                  ...
                  <br />
                  "balance":
                  <span style={{ color: "#FCC82B" }}>503.89</span>{" "}
                  <span style={{ color: "#fff" }}>,</span>
                  <br />
                  "transaction_name":{" "}
                  <span
                  ...
                  <span style={{ color: "#17FF93" }}>
                    "Balance ledger has been successfully fetched"
                  </span>{" "}
                  <br />
                  <span style={{ color: "#fff" }}>{"}"}</span>
                </Typography>
              ...
              <Box bgcolor={"#004E6D"} p={3} mt={3} borderRadius={3} mb={10}>
                ...
                >
                  ...
                  "note":
                  <span style={{ color: "#17FF93" }}>
                    "Balance ledger could not be fetched"
                  </span>
                  <br />
                  <span style={{ color: "#fff" }}>{"}"}</span>
                </Typography>
          ...
          <Grid item md={3}>
            <BalanceLedgerSidebar anchor={"right"} />
          </Grid>
        </Grid>
      </Box>
    </Box>
