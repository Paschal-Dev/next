...
import EditOffersSidebar from "./editsidebar";

export default function EditOffers(): React.JSX.Element {
    ...
    <Box>
      ...
      <Box bgcolor={"whitesmoke"}>
        <Grid container spacing={5}>
            ...
            <Container id="Transaction-Receipt">
              ...
              >
                ...
                <Typography
                  ...
                  id="End-Point"
                >
                  If you have an active offer on Peerwallet, you can modify the
                  exchange rate, minimum order & the maximum order for the
                  offer.
                </Typography>
              </Box>
              <hr
              ...
              <Box bgcolor={"#004E6D"} p={3} mt={3} borderRadius={3}>
                ...
                >
                  ...
                  <span style={{ color: "#17FF93" }}>
                    {" "}
                    "Offer has been successfully modified"
                  </span>{" "}
                  <br />
                  <span style={{ color: "#fff" }}>{"}"}</span>
                </Typography>
              ...
              <Box bgcolor={"#004E6D"} p={3} mt={3} borderRadius={3} mb={10}>
                ...
                >
                  ...
                  "note":
                  <span style={{ color: "#17FF93" }}>
                  "Error encountered when modifying offer"
                  </span>
                  <br />
                  <span style={{ color: "#fff" }}>{"}"}</span>
                </Typography>
          ...
          <Grid item md={3}>
            <EditOffersSidebar anchor={"right"} />
          </Grid>
        </Grid>
      </Box>
    </Box>
