...
export default function FirstRightBar({
  anchor,
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ["getting-started", "apidoc"];
      sections.forEach((id) => {
            ...
            <ul style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}>
              <li
                ...
                style={{
                  ...
                  listStyleType: "disc",
                  cursor: "pointer",
                  color: activeLink === "getting-started" ? "#009FDD" : "#000",
                }}
              >
              ...
              <li
                onClick={() => handleClick("apidoc")}
                style={{
                  listStyleType: "disc",
                  cursor: "pointer",
                  color: activeLink === "apidoc" ? "#009FDD" : "#000",
                }}
              >
                <Link href="#apidoc" color="inherit" underline="none">
                  Documentation
                </Link>
              </li>
            </ul>
