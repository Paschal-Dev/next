...
import AvailableLanguagesSidebar from "./availablelanguagessidebar";

export default function AvailableLanguages(): React.JSX.Element {
    ...
    <Box>
      ...
      <Box bgcolor={"whitesmoke"}>
        <Grid container spacing={5}>
            ...
            <Container>
              ...
              >
                ...
                <Typography
                  ...
                  id="End-Point"
                >
                  View all the active languages on Peerwallet.
                </Typography>
              </Box>
              <hr
                style={{
              ...
              <Box bgcolor={"#004E6D"} p={3} mt={3} borderRadius={3}>
                ...
                >
                  ...
                  <br />
                  "code":
                  <span style={{ color: "#17FF93" }}>"fr"</span>{" "} <br />
                  <span style={{ color: "#fff" }}>{"},"}</span>
                  <br />
                  <span style={{ color: "#fff" }}>{"{"}</span> <br />
                  "name":{" "}
                  ...
                  <span style={{ color: "#fff" }}>,</span> <br />
                  "code":
                  <span style={{ color: "#17FF93" }}>"az"</span>{" "}
                  
                  <br />
                  <span style={{ color: "#fff" }}>{"},"}</span> <br />
                  <span style={{ color: "#17FF93" }}>"e.t.c"</span>{" "}
              ...
              <Box bgcolor={"#004E6D"} p={3} mt={3} borderRadius={3} mb={8}>
                ...
                >
                  ...
                  "note":
                  <span style={{ color: "#17FF93" }}>
                    "Available languages could not be fetched"
                  </span>
                  <br />
                  <span style={{ color: "#fff" }}>{"}"}</span>
                </Typography>
          ...
          <Grid item md={3}>
            <AvailableLanguagesSidebar anchor={"right"} />
          </Grid>
        </Grid>
      </Box>
    </Box>
