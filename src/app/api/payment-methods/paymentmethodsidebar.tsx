...
export default function PaymentMethodSidebar({ anchor }:SidebarProps):React.JSX.Element{
      ...
      isDesktop ? (
        ...
        >
          <Box pt={3}>
              ...
              <ul style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}>
                ...
                >
                  <Link
                    ...
                    underline="none"
                  >
              Payment Integrattion & Payment Links
                  </Link>
                </li>
                <li
                ...
                <li
                  onClick={() => handleClick("Explanation-Table")}
                  style={{
                    paddingBottom: 2,
                    listStyleType: "disc",
                    cursor: "pointer",
                ...
                >
                  ...
                  <li
                    onClick={() => handleClick("Post-Fields")}
                    style={{
                      paddingBottom: 2,
                      listStyleType: "disc",
                      cursor: "pointer",
            ...
            >
              <Image src={bar} alt="" style={{ width: "95%", marginTop: -70 }} />
              <Typography
                variant="body2"
                fontWeight={900}
                fontSize={"18px"}
