...
export default function PaymentVerificationSidebar({ anchor }:SidebarProps): React.JSX.Element {
          ...
          <ul style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}>
            ...
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "Payment-Verification" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#Payment-Verification" color="inherit" underline="none">
            ...
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "Return-Values- Error-Sample" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#Return-Values-Error-Sample" color="inherit" underline="none">
