...
export default function SecondRightBar({ anchor }:SidebarProps): React.JSX.Element {
          ...
          <ul style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}>
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "payment" ? "#009FDD" : "#000",
              }}
            >
            ...
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "explanation" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#explanation" color="inherit" underline="none">
                Explanation Table
              </Link>
            </li>
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "premium" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#premium" color="inherit" underline="none">
                Premium
              </Link>
            </li>
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "field" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#field" color="inherit" underline="none">
                Post Fields
              </Link>
            </li>
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "success" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#success" color="inherit" underline="none">
            ...
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "error" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#error" color="inherit" underline="none">
