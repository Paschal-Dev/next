...
export default function RecurringSidebar({ anchor }:SidebarProps): React.JSX.Element{
          ...
          <ul style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}>
            <li
              ...
              style={{
                ...
                listStyleType: "disc",
                cursor: "pointer",
                color: activeLink === "Reccuring-Payments" ? "#009FDD" : "#000",
              }}
            >
              <Link href="#Reccuring-Payments" color="inherit" underline="none">
               Recurring Payments
              </Link>
            </li>
            <li
