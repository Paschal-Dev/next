...
export default function VirtualCardServicesSideBar({ anchor }:SidebarProps): React.JSX.Element{
              ...
              <ul style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}>
                ...
                <li
                  ...
                  style={{
                    ...
                    listStyleType: "disc",
                    cursor: "pointer",
                    color: activeLink === "create" ? "#009FDD" : "#000",
                  }}
                >
                ...
                <li
                  ...
                  style={{
                    ...
                    listStyleType: "disc",
                    cursor: "pointer",
                    color: activeLink === "fetch" ? "#009FDD" : "#000",
                  }}
                >
                  <Link href="#fetch" color="inherit" underline="none">
                  ...
                  <li
                    ...
                    style={{
                      ...
                      listStyleType: "disc",
                      cursor: "pointer",
                      color: activeLink === "load" ? "#009FDD" : "#000",
                    }}
                  >
                    <Link href="#load" color="inherit" underline="none">
                      Load virtual card
                    </Link>
                  </li>
                  <li
