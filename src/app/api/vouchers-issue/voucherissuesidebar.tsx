...
export default function VoucherIssueSidebar({ anchor }:SidebarProps): React.JSX.Element{
  const [activeLink, setActiveLink] = useState<string>("");

  useEffect(() => {
    const handleScroll = () => {
      const sections = ["issue", "point"];
      sections.forEach((id) => {
              ...
              <ul style={{ fontWeight: 700, fontSize: "14px", paddingLeft: 20 }}>
                <li
                  ...
                  style={{
                    ...
                    listStyleType: "disc",
                    cursor: "pointer",
                    color: activeLink === "issue" ? "#009FDD" : "#000",
                  }}
                >
                  <Link href="#issue" color="inherit" underline="none">
                  Vouchers - Issue
                  </Link>
                </li>
                <li
                  onClick={() => handleClick("poinnt")}
                  style={{
                    listStyleType: "disc",
                    cursor: "pointer",
